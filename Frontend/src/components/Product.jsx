        ...
        <div className="right-column" style={{ width: "50%" }}>
          ...
          <div className="product-price">
            ...
            <button
              ...
              >
                 <i className="bi bi-cart-plus text-white"></i> Add to Cart
              </button>
            {/* <button
              className={`btn btn-success ${!product.productAvailable ? "disabled" : ""}`}
              onClick={handlAddToCart}
              disabled={!product.productAvailable}
              style={{
                padding: "1rem 2rem",
          ...
          <div className="d-flex gap-3 mt-4">
            ...
            >
              <i className="bi bi-pencil-square me-2 text-white"></i>
              Update
            </button>
            ...
            >
              <i className="bi bi-trash3 me-2 text-white"></i>
              Delete
            </button>
          </div>
          </div>
